...
local test = {
   ...
   "Are you a motorway? Because i want to run you over 😩",
   ...
   "Lemme teach you something that they don't teach you in the classroom 😉",
   "Are you a painting because i could pin you against my wall",
   "Are you Grass? because if you are, that's the only time I'd touch it.",
   "I wish I was garbage so you would take me out once a week",
   ...
   "Are you the school stairs? because you took my breath away",
   ...
   "Are you a dictionary? Cause you’re adding a meaning to my life.",
   ...
   "You remind me of a dictionary in the way you add a meaning to everything.",
   ...
   "Roses are red and violets are twisted, bend o ver beacuse you're getting fisted",
   "Come over to my place to do maths, first we add the bed, subtract the clothes - divide our legs and multiply",
}
